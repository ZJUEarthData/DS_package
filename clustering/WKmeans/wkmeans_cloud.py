# -*- coding: utf-8 -*-
"""
Created on Thu Oct  8 16:43:58 2020
...
def main():
    ...
    feature= pd.read_excel(FEATURE_FILE_PATH) # read initial features from feature.xlsx file
    ...
    result.to_csv(OUTPUT_MODEL+"wkmeans_weight_{}.csv".format(TIMESTAMP), index=None)
